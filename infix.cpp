...
public:
    ...
    int calculate(string postfixExpression)
    {
      ...
      for(int i=0;i<postfixExpression.length();++i)
      {
        ...
        {
          cout<<"Enter "<<postfixExpression[i]<<":"<<endl;
          int x;
          cin>>x;
...
int main() {
    ...
    cout<<"Converting Infix to postfix and evaluating the expression:"<<endl;
    ...
    while(1)
    {
      cout<<"do you want to evaluate expression as well"<<endl;
